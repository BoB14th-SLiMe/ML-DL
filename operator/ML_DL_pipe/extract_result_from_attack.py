...
python extract_result_from_attack.py --input-jsonl ./attack_data/2.jsonl --window-size 80 --window-step 5 --stop-after-windows 999999 --alarm --alarm-base-url http://192.168.4.140:8080 --alarm-engine dl --dl-output-path /home/slime/SLM/DL/output/dl_anomaly_detect.jsonl
